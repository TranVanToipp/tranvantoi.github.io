            ...
            <div class="top-bar">
                        ...
                        <div class="header-social">
                            <div class="header-social-phone header-social-phone-sdt">
                                <div class="header-social-phone-box">
                                    ...
                                    <a href="tel: 0392518760" class="header-phone-number tag-a">0392518760</a>
                                </div>
                ...
                <div class="masthead">
                    <div class="grid wide header-masthread">
                        ...
                        <div class="logo">
                            <a href="<?=$baseUrl?>">
                                <img src="<?=$baseUrl?>FE/img/logo2.jpg" alt="Ảnh logo giao diện chính" class="logo-img">
                            </a>
                        </div>
                        <!-- TÌm kiếm -->
                        <div class="masthead-search">
                            <div class="masthead-search-box">
                                <form action="../../../../../project_Mon_Wed/search" class="header-search-form">
                                    <input name="search" type="text" placeholder="Tìm kiếm tên sản phẩm" class="header-search-input">
